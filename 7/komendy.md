...
b. sudo ip addr add 10.123.89.1/24 dev eth1
c. sudo ip link set eth1 up
d. sudo ip route add default via 10.123.89.254
...
```
subnet 10.123.89.0 netmask 255.255.255.0 {
  option domain-name-servers 1.1.1.1;
  option routers 10.123.89.1;
  range 10.123.89.100 10.123.89.200;
}
```
